...
public abstract class ExpandableSupportExt<Source extends JComponent> implements Expandable {
    ...
    public ExpandableSupportExt(@NotNull Source source, Function<? super String, @Nls String> onShow, Function<? super String, String> onHide) {
        this.source = source;
