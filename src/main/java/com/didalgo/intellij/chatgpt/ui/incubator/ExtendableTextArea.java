...
public class ExtendableTextArea extends JBTextArea implements ExtendableTextComponent {
    ...
    public ExtendableTextArea(int columns) {
        this(null, columns);
    }

    public ExtendableTextArea(@Nls String text) {
        this(text, 20);
    }

    public ExtendableTextArea(@Nls String text, int columns) {
    ...
    public ExtendableTextArea addBrowseExtension(@NotNull Runnable action, @Nullable Disposable parentDisposable) {
