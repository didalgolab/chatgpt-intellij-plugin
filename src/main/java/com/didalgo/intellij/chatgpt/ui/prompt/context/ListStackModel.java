...
public class ListStackModel<T> extends AbstractListModel<T> {
    ...
    private final ListStackStep<T> myStep;
    ...
    public ListStackModel(ElementFilter<? super T> filter, SpeedSearch speedSearch, ListStackStep<T> step) {
        myFilter = filter;
        myStep = step;
