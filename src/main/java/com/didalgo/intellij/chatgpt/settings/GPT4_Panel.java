...
public class GPT4_Panel implements Configurable {
    ...
    private void init() {
        ...
        enableCustomizeGpt4UrlCheckBox.addItemListener(proxyTypeChangedListener);
        enableCustomizeServerOptions(false);
        initHelp();
    }
    ...
    public void reset() {
        ...
        enableCustomizeGpt4UrlCheckBox.setSelected(config.isEnableCustomizeGpt35TurboUrl());
    ...
    public boolean isModified() {
        ...
        return !config.getApiKey().equals(AES.encrypt(apiKeyField.getText())) ||
                ...
                config.isEnableCustomizeGpt35TurboUrl() != enableCustomizeGpt4UrlCheckBox.isSelected() ||
    ...
    public void apply() {
        ...
        config.setEnableCustomizeGpt35TurboUrl(enableCustomizeGpt4UrlCheckBox.isSelected());
